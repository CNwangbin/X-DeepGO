...
def get_target_terms(embeds,
                     in_terms_file='./data/terms.pkl',
                     out_terms_file='./data/terms_emb_200_pd.pkl'):
    ...
    for i in range(len(terms)):
        ...
        elif terms[i] == 'GO:0033613' or terms[i] == 'GO:0070491' or terms[
                i] == 'GO:0001107':
            terms_emb[i] = embeds['GO:0140297']
        elif terms[i] == 'GO:0001102' or terms[i] == 'GO:0001085' or terms[
                i] == 'GO:0001103':
